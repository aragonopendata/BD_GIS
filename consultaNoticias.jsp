...
<%
// Jsp que conecta con BBDD Oracle y muestra por pantalla las Noticias que existen en la tabla "carto.t_web_sitar_noticias"
// @documento: consultaNoticias.jsp
...
// @fecha: Diciembre 2011
    ...
    ResultSet rs=null;//Objeto para guardar los resultados
		...
		rs=stmt.executeQuery("select * from carto.t_web_sitar_noticias where tipo='Noticia' and fechabaja = 99999999");
		 while (rs.next()){
