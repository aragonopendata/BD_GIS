...
/**
* @file ConsultaOracleDes.java
* @author Maria TENA AINA
* @version 1.4
* @date Junio 2013
* @description Clase que conecta con BBDD Oracle en Sita2 y hace una consulta a una Tabla de dicha BBDD con Pool de Conexiones
*/
...
public class ConsultaOracleDes extends HttpServlet {
  ...
  private DataSource ds = null;
    ...
    try {
      ...
      ds = (DataSource) ctx.lookup("java:comp/env/jdbc/conexOracleSita");
    }
    
		catch (Exception e) {
      throw new ServletException("Imposible recuperar jdbc/conexOracleSita",e);
    }
    ...
    try {
        ...
        //Mostramos las distintas noticias
				while(resultados.next()) { 
									out.println(resultados.getString(campo)+"<br>");
									}//Fin while
