    ...
    Statement stmt=null;//Objeto para la ejecucion de sentencias
		try {
			...
			stmt = conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
				...
				//out.println("INSERT INTO carto.log_busquedas(literal, timestamp, app) VALUES ('"+literal+"','"+fecha+"','"+app+"')");
			int datos=stmt.executeUpdate("INSERT INTO carto.log_busquedas(literal, timestamp, app,ip) VALUES ('"+literal+"','"+fecha+"','"+app+"','"+ip+"')");
