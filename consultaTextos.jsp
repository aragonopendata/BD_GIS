...
<%
// Jsp que conecta con BBDD Oracle y muestra por pantalla los registros que existen en la tabla "carto.t_web_sitar_textos"
// @documento: consultaTextos.jsp
...
// @fecha: Diciembre 2011
    ...
    ResultSet rs=null;//Objeto para guardar los resultados
		...
		rs=stmt.executeQuery("select * from carto.t_web_sitar_textos where texto_id="+numero+" AND idioma_cod='"+idioma+"'" );
		 while (rs.next()){
			          out.println(rs.getString("texto")+"<br>");
			      }
						rs.close();
