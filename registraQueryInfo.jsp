...
// @documento: registraQueryInfo.jsp
// @author: Idearium Consultores
// @fecha: Septiembre 2014

		String theX = request.getParameter("x");
		String theY = request.getParameter("y");
    ...
    Statement stmt=null;//Objeto para la ejecucion de sentencias
		try {
			...
			stmt = conn.createStatement(ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
				...
				//out.println("INSERT INTO carto.log_query_info(x, y, timestamp, app,ip) VALUES ('"+theX+"','"+ theY+"','"+fecha+"','"+app+"','"+ip+"')");
			int datos=stmt.executeUpdate("INSERT INTO carto.log_query_info(x, y, timestamp, app,ip) VALUES ('"+theX+"','"+ theY+"','"+fecha+"','"+app+"','"+ip+"')");
